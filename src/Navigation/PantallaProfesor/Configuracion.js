...
const Configuracion = ({navigation: {navigate} }) =>{
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.infoUser}>
        ...
        <Text style={styles.textTitle}>{ infoUser.PNombreProfesor + " " + infoUser.SNombreProfesor + " " +  infoUser.PApellidoProfesor + " " + infoUser.SApellidoProfesor }</Text>
