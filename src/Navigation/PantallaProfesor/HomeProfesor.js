...
function HomeProfesor( {navigation: {navigate} } ){
    ...
    return (
        ...
        <SafeAreaView style={styles.container}>
            ...
            <Image source={ require ('../../images/pexels-cottonbro-studio-7207354.jpg') } style={ [ styles.background , StyleSheet.absoluteFill ] }/>
            ...
            <View style={[styles.container, {flex: 2, justifyContent: 'center',}]}>
                ...
                <View style = {[styles.windowInfoUser, styles.shadow]}>
                    ...
                    <View style={[styles.container, { flex: 1.5, justifyContent: 'center'}]}>
                        ...
                        <Text style={styles.textSubTitle}>{ infoUser.PNombreProfesor + " " + infoUser.PApellidoProfesor + " " + infoUser.SApellidoProfesor }</Text>
                    ...
                    <View style={[styles.shadow, styles.ventanaDeBotonera]}>
                        ...
                        <View style={[ styles.container, {flexDirection: 'row'}]}>
                            ...
                            <View style={styles.containerCentralizador}>
                                ...
                                <TouchableOpacity style={[styles.botonesInferiores, styles.shadow2]} onPress= {() => navigate('CentrosDeportivos', { Pantalla: 'Horario' })}>
                            ...
                            <View style={styles.containerCentralizador}>
                                ...
                                <TouchableOpacity style={[styles.botonesInferiores, styles.shadow2, {borderColor: '#20A83E'}]} onPress= {() => navigate('CentrosDeportivos', { Pantalla: 'ListaDeAsistencia' })}>

                                    <Icon name='list' size={40} color={'#20A83E'}/>
                        ...
                        <View style={[styles.container,{flexDirection: 'row'}]}>
                            ...
                            <View style={styles.containerCentralizador}>
                                ...
                                <TouchableOpacity style={[styles.botonesInferiores, styles.shadow2, {borderColor: '#2D6BC2'}]} onPress= {() => navigate('CentrosDeportivos', { Pantalla: 'Inventario' })}>

                                    <Icon name='inventory' size={40} color={'#2D6BC2'}/>
                            ...
                            <View style={styles.containerCentralizador}>
                                ...
                                <TouchableOpacity style={[styles.botonesInferiores, styles.shadow2, {borderColor: '#F36A34'}]} onPress= {() => navigate('Formulario')}>
...
/*
            ...
            <View style={[styles.container, {flex: 2, justifyContent: 'center', flexDirection: 'row'}]}>
                ...
                <View style={[styles.container, { flex: 1.5, justifyContent: 'center'}]}>
                    ...
                    <Text style={styles.SubtituloRut}>{infoUser.Rut}</Text>
                    <Text style={styles.SubtituloNombre}>{ infoUser.PNombreProfesor + " " + infoUser.PApellidoProfesor + " " + infoUser.SApellidoProfesor }</Text>
            ...
            <View style={[styles.container, { flex: 6 }]}>
                ...
                <View style={styles.containerCentralizador }>
                    ...
                    <TouchableOpacity style={[styles.shadow , styles.botonTablonDeAnuncio]} onPress= {() => navigate('TablonDeAnuncios')}>

                        <Text style={styles.textAnuncios }>Tablon De Anuncios</Text>
...
/* OPCION 2
            ...
            <View style={styles.topView}>
                ...
                <TouchableOpacity style={styles.settings} onPress= {() => navigate('Configuracion')}>
                ...
                <View style={styles.containerInfoUser} >
                    ...
                    <Image source={ require ('../../images/Ganemosle-a-la-calle.png') } style={ styles.logo }/>
