...
const CambiarEmail = ({navigation: {navigate}}) =>  {

    const [email, setemail] = useState("");
    const { emailReset , errorResetEmail, isLoading} = useContext(AuthenticationContext)
        ...
        <SafeAreaView style={ styles.containerCentralizador }>
            ...
            <ScrollView style={ styles.opacidadBlanca }>
                ...
                <View style={styles.containerText} >
                    ...
                    <Text style={styles.title} >Restablecer Dirección de correo electrónico</Text>
                    <Text style={styles.subTitle}>Introduce la nueva dirección de correo electrónico.</Text>
