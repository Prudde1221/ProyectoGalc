...
const ConfiguracionAlumnno = ({navigation: {navigate} }) =>{
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.infoUser}>
        ...
        <Text style={styles.textTitle}>{ infoUser.PNombreAlumno + " " + infoUser.SNombreAlumno + " " +  infoUser.PApellidoAlumno + " " + infoUser.SApellidoAlumno }</Text>
        ...
        <Text style={[styles.textSubTitle,{marginBottom: 20}]}>Telefono: { infoUser.NumeroTelAlumno}</Text>
...
export default ConfiguracionAlumnno;